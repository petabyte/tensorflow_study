...
negative_samples = 8
LOG_DIR = '/Users/gsanchez/tensorflow_book/tmp/word2_vec'
...
for i in range(10000):
    ...
    sentences += [" ".join([digit_to_word_map[r] for r in rand_even_ints])]
...
for sent in sentences:
    for word in sent.lower().split():
        if word not in word2index_map:
            ...
            index += 1
index2word_map = dict([(index, word) for
                       word, index in word2index_map.items()])
